	...
	command = {
		tp = {
			...
			params = {
				x = {
					name = "id/x",
					help = "ไอดีของผู้เล่น หรือ พิกัด x",
				},
		...
		tpm = {
			help = "เคลือนย้ายไปบังจุดมาร์ค (สำหรับ Admin)",
		},
		...
		openserver = {
			help = "เปิดเซิฟเวอร์สำหรับทุกคน (สำหรับ Admin)",
		},
		closeserver = {
		...
		givemoney = {
			...
			params = {
				...
				moneytype = {
					name = "moneytype",
					help = "ประเภทของเงิน (เงินสด, เงินฝาก, คริปโต)",
				},
