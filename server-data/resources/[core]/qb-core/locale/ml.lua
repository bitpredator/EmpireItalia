	...
	command = {
		tp = {
			...
			params = {
				x = {
					name = "id/x",
					help = "കളിക്കാരൻ്റെ ഐഡി അല്ലെങ്കിൽ X സ്ഥാനം",
				},
		...
		togglepvp = {
			help = "സെർവറിൽ PVP ടോഗിൾ ചെയ്യുക (അഡ്മിൻ മാത്രം)",
		},
		addpermission = {
		...
		openserver = {
			help = "എല്ലാവർക്കുമായി സെർവർ തുറക്കുക (അഡ്മിൻ മാത്രം)",
		},
		closeserver = {
			...
			params = {
				reason = {
					name = "കാരണം",
					help = "അടയ്ക്കാനുള്ള കാരണം (ഓപ്ഷണൽ)",
				},
			},
		},
		car = {
			...
			params = {
				model = {
					name = "മാതൃക",
					help = "വാഹനത്തിൻ്റെ മോഡൽ പേര്",
				},
			},
		},
		dv = { help = "വാഹനം ഇല്ലാതാക്കുക (അഡ്മിൻ മാത്രം)" },
		dvall = {
			help = "എല്ലാ വാഹനങ്ങളും ഇല്ലാതാക്കുക (അഡ്മിൻ മാത്രം)",
		},
		dvp = {
			help = "എല്ലാ പെഡുകളും ഇല്ലാതാക്കുക (അഡ്മിൻ മാത്രം)",
		},
		dvo = {
			help = "എല്ലാ ഒബ്ജക്റ്റുകളും ഇല്ലാതാക്കുക (അഡ്മിൻ മാത്രം)",
		},
		givemoney = {
			...
			params = {
				...
				moneytype = {
					name = "പണത്തിൻ്റെ തരം",
					help = "പണത്തിൻ്റെ തരം (പണം, ബാങ്ക്, ക്രിപ്റ്റോ)",
				},
