local Translations = {
	...
	command = {
		...
		togglepvp = {
			help = "சர்வரில் பிவிபியை நிலைமாற்று (நிர்வாகம் மட்டும்)",
		},
		addpermission = {
		...
		openserver = {
			help = "அனைவருக்கும் சேவையகத்தைத் திறக்கவும் (நிர்வாகம் மட்டும்)",
		},
		closeserver = {
			...
			params = {
				reason = {
					name = "reason",
					help = "மூடுவதற்கான காரணம் (விரும்பினால்)",
				},
			},
		},
		car = {
		...
		dv = {
			help = "வாகனத்தை நீக்கு (நிர்வாகம் மட்டும்)",
		},
		dvall = {
			help = "அனைத்து வாகனங்களையும் நீக்கு (நிர்வாகம் மட்டும்)",
		},
		dvp = {
			help = "அனைத்து பெட்களையும் நீக்கு (நிர்வாகம் மட்டும்)",
		},
		dvo = {
			help = "அனைத்து பொருட்களையும் நீக்கு (நிர்வாகம் மட்டும்)",
		},
		givemoney = {
			...
			params = {
				...
				moneytype = {
					name = "moneytype",
					help = "பணத்தின் வகை (பணம், வங்கி, கிரிப்டோ)",
				},
