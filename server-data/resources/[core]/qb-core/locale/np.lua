local Translations = {
	...
	command = {
		...
		tpm = {
			help = "मार्करमा टेलिपोर्ट गर्नुहोस् (केवल प्रशासक)",
		},
		togglepvp = {
			help = "सर्भरमा PVP सक्रिय/निष्क्रिय गर्नुहोस् (केवल प्रशासक)",
		},
		addpermission = {
		...
		openserver = {
			help = "सबैलाई सर्भर खोल्नुहोस् (केवल प्रशासक)",
		},
		closeserver = {
		...
		dv = {
			help = "सवारी साधन मेटाउनुहोस् (केवल प्रशासक)",
		},
		dvall = {
			help = "सबै सवारी साधन मेटाउनुहोस् (केवल प्रशासक)",
		},
		dvp = { help = "सबै NPC मेटाउनुहोस् (केवल प्रशासक)" },
		dvo = {
			help = "सबै वस्तुहरू मेटाउनुहोस् (केवल प्रशासक)",
		},
		givemoney = {
			...
			params = {
				...
				moneytype = {
					name = "moneytype",
					help = "पैसाको प्रकार (नगद, बैंक, क्रिप्टो)",
				},
