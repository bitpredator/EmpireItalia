local Translations = {
	...
	command = {
		...
		tpm = {
			help = "Телепортуватися до маркера (тільки адміністратори)",
		},
		togglepvp = {
			help = "Включити/вимкнути PVP на сервері (тільки адміністратори)",
		},
		addpermission = {
		...
		openserver = {
			help = "Відкрити сервер для всіх (тільки адміністратори)",
		},
		closeserver = {
		...
		dvall = {
			help = "Видалити всі транспортні засоби (тільки адміністратори)",
		},
		...
		givemoney = {
			...
			params = {
				...
				moneytype = {
					name = "moneytype",
					help = "Тип грошей (готівка, банк, криптовалюта)",
				},
